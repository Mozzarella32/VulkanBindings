...
template struct impl_Struct::AssignableHandle<DebugReportCallbackEXT>;
template struct impl_Struct::AssignableHandle<DebugUtilsMessengerEXT>;
template struct impl_Struct::AssignableHandle<DeferredOperationKHR>;
...
template struct impl_Struct::AssignableHandle<Device>;
...
template struct impl_Struct::AssignableHandle<ExternalComputeQueueNV>;
...
template struct impl_Struct::AssignableHandle<Instance>;
template struct impl_Struct::AssignableHandle<MicromapEXT>;
template struct impl_Struct::AssignableHandle<OpticalFlowSessionNV>;
template struct impl_Struct::AssignableHandle<PerformanceConfigurationINTEL>;
...
template struct impl_Struct::AssignableHandle<PipelineCache>;
template struct impl_Struct::AssignableHandle<PipelineLayout>;
template struct impl_Struct::AssignableHandle<PrivateDataSlot>;
...
template struct impl_Struct::AssignableHandle<ShaderInstrumentationARM>;
