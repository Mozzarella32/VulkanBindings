...
Unique<Handle_T, Creator_T>::Unique(Handle_T &&h, impl_Loader::Dispatcher *dispatch)
    : handle(h), dispatch(dispatch) {}
...
template <typename Handle_T, typename Creator_T>
Handle_T *Unique<Handle_T, Creator_T>::rawHandlePtr() const noexcept {
    return &handle;
}
template <typename Handle_T, typename Creator_T>
...
OwnedUnique<Handle_T, Owner_T, Owner_Handle_T>::OwnedUnique(Handle_T &&h, Owner_Handle_T o,
    ...
    : handle(h), owner(o), dispatch(dispatch) {}
...
template <typename Handle_T, typename Owner_T, typename Owner_Handle_T>
Handle_T *OwnedUnique<Handle_T, Owner_T, Owner_Handle_T>::rawHandlePtr() const noexcept {
    return &handle;
}
...
NonOwned<Handle_T>::NonOwned(Handle_T &&handle, impl_Loader::Dispatcher *dispatch)
    : handle(std::move(handle)), dispatch(dispatch) {}
...
template <typename Handle_T> Handle_T *NonOwned<Handle_T>::rawHandlePtr() const noexcept {
    return &handle;
}
